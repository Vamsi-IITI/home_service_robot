...
gnome-terminal -e 'bash -c "source ~/home_service_robot/devel/setup.bash"';
gnome-terminal -e 'bash -c "roslaunch turtlebot3_navigation turtlebot3_navigation.launch map_file:=$HOME/home_service_bot/src/autonomous_turtlebot3/map/home1.yaml "' &
